...
// Make TypeScript aware of the custom element for the ElevenLabs widget
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'elevenlabs-convai': { 'agent-id': string } & React.HTMLAttributes<HTMLElement>;
    }
  }
}
    ...
    return (
        ...
        >
            ...
            <div className="flex-grow bg-slate-950/50">
                {/* The widget will be mounted here by its own script */}
